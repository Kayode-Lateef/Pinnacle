        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block language-switch">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <!-- item-->
                    <a href="{{ route('admin.locale', ['locale' => 'it']) }}" class="dropdown-item notify-item">
                        <img src="{{ URL::asset('assets/images/flags/italy.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italian</span>
                    </a>

                    <!-- item-->
                    <a href="{{ route('admin.locale', ['locale' => 'ru']) }}" class="dropdown-item notify-item">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ route('admin.profile') }}"><i class="uil uil-user-circle font-size-18 align-middle text-muted me-1"></i> <span class="align-middle">@lang('translation.View_Profile')</span></a>
                    <a class="dropdown-item d-block" href="{{ route('admin.editProfile') }}"><i class="uil uil-cog font-size-18 align-middle me-1 text-muted"></i> <span class="align-middle">@lang('translation.Settings')</span></a>
