                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="card card-body">
                            ...
                            <form class="custom-validation" action="{{ route('admin.updateProfile') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                        ...
                        <!-- <div class="card card-body">
                            ...
                            <form class="custom-validation" action="{{ route('admin.updateProfile') }}" method="POST">
                                @csrf
                        ...
                        <div class="card card-body">
                            ...
                            <form action="{{ route('admin.destroy', $user) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <button type="submit" class="btn btn-danger waves-effect waves-light me-1" onclick="return confirm('Are you sure you want to delete your account? This action cannot be undone.');">Delete Account</button>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="custom-validation" action="{{ route('admin.password.update') }}" method="POST">
                                    @csrf
