...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <a href="{{ route('admin.sub_topics.create') }}" class="mb-2 btn btn-success waves-effect waves-light btn-sm"><i class="mdi mdi-plus"></i>Add Subtopics</a>
                ...
                <table id="datatable" class="table table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $subtopic->name }}</td>
                            <td>
                                <a href="{{ route('admin.sub_topics.edit', $subtopic->id) }}" class="mb-2 btn btn-outline-info waves-effect waves-light btn-sm"><i class="mdi mdi-pencil"></i></a>

                                <!-- Delete Button/Form -->
                                <form action="{{ route('admin.sub_topics.destroy', $subtopic->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
