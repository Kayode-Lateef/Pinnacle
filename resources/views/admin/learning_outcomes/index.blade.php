...
<div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <a href="{{ route('admin.learning_outcomes.create') }}" class="mb-2 btn btn-success waves-effect waves-light btn-sm"><i class="mdi mdi-plus"></i>Add Learning Outcomes</a>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.learning_outcomes.edit', $learning_outcome->id) }}" class="mb-2 btn btn-outline-info waves-effect waves-light btn-sm"><i class="mdi mdi-pencil"></i></a>

                                        <!-- Delete Button/Form -->
                                        <form action="{{ route('admin.learning_outcomes.destroy', $learning_outcome->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
