                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="mt-5 mt-lg-4">
                            ...
                            <form class="outer-repeater" action="{{ route('siteadmin.curriculum.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div data-repeater-list="inner-group" class="inner form-group">
                                                ...
                                                <div data-repeater-item class="inner mb-3 row">
                                                    <div class="col-md-10 col-8">
                                                        <input type="text" name="learning_outcomes" class="inner form-control @error('learning_outcomes') is-invalid @enderror" placeholder="Learning Outcomes" required />
