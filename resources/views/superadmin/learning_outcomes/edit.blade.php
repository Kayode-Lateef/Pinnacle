                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="mt-5 mt-lg-4">
                            ...
                            <form action="{{ route('siteadmin.learning_outcomes.update', $learningOutcome->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="subject_id" id="subject_id" class="form-select" required>
                                        ...
                                        <option value="{{ $subject->id }}" {{ $learningOutcome->subject_id == $subject->id ? 'selected' : '' }}>{{ $subject->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('subject_id')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" style="display:none;">{{ $learningOutcome->description }}</textarea>
                                </div>

                                <div class="row">
                                    <div class="col-sm-9">
                                        <button type="submit" class="btn btn-primary waves-effect waves-light w-md">Update Learning Outcome</button>
                                    </div>
                                </div>
                            </form>
...
<script>
      ClassicEditor
        ...
        .then(editor => {
            ...
            editor.setData(`{{ strip_tags($learningOutcome->description) }}`);
