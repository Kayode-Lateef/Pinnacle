...
@slot('title') Add Testimonials @endslot
@endcomponent
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mt-5 mt-lg-4">
                            ...
                            <form action="{{ route('siteadmin.testimonial.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="row mb-4">
                                    <label for="authorname" class="col-sm-3 col-form-label">Author Name</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="author" class="form-control @error('author') is-invalid @enderror" placeholder="Author Name" required>
                                        @error('author')
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="position" class="form-control @error('position') is-invalid @enderror" placeholder="Author Position">
                                        @error('position')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="content" class="form-control @error('content') is-invalid @enderror" placeholder="Testimonial Content" min="50" required></textarea>
                                        @error('content')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-sm-9">
                                        <div class="d-flex flex-wrap gap-3">
                                            <button type="submit" class="btn btn-primary waves-effect waves-light w-md">Add Testimonial</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
