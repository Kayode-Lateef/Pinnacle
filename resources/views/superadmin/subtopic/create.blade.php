...
@slot('title') Add Subtopic @endslot
@endcomponent
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="mt-5 mt-lg-4">
                            ...
                            <form  action="{{ route('siteadmin.sub_topics.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Subtopic name" required>
                                            @error('name')
                                ...
                                <div class="row">
                                    <div class="col-sm-9">
                                        <button type="submit" class="btn btn-primary waves-effect waves-light w-md">Add Subtopic</button>
