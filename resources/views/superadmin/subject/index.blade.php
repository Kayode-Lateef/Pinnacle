...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <a href="{{ route('siteadmin.subjects.create') }}" class="mb-2 btn btn-success waves-effect waves-light btn-sm"><i class="mdi mdi-plus"></i>Add Subjects</a>
                ...
                <table id="datatable" class="table table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('siteadmin.subjects.edit', $subject->id) }}" class="mb-2 btn btn-outline-info waves-effect waves-light btn-sm"><i class="mdi mdi-pencil"></i></a>

                                <!-- Delete Button/Form -->
                                <form action="{{ route('siteadmin.subjects.destroy', $subject->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
