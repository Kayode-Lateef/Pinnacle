...
class LearningOutcomeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.learning_outcomes.index', compact('learning_outcomes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.learning_outcomes.create', compact('subjects'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.learning_outcomes.index')->with('success', 'Learning Outcome created successfully.');
    }

    public function edit(LearningOutcome $learningOutcome)
    {
        $subjects = Subject::all();
        return view('admin.learning_outcomes.edit', compact('learningOutcome','subjects'));
    }
    ...
    public function update(Request $request, LearningOutcome $learningOutcome)
    {
        ...
        return redirect()->route('admin.learning_outcomes.index')->with('success', 'Learning outcome updated successfully.');
    }
    ...
    public function destroy(LearningOutcome $learningOutcome)
    {
        ...
        return redirect()->route('admin.learning_outcomes.index')->with('success', 'Learning Outcome deleted successfully.');
    }
}
